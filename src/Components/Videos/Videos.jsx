    ...
    return (
        <div>
            {videos.map((value, index) => {
                return (
                    <a key={index} className='p-1 max-w-sm rounded overflow-hidden shadow-lg flex flex-col justify-center items-center' href={'https://www.youtube.com/watch?v=' + value._id}>
                        <img className='w-11/12' src={'https://img.youtube.com/vi/' + value._id + '/mqdefault.jpg'} alt='Sunset in the mountains' />
                        <div className='px-4 py-2 flex flex-col items-baseline'>
